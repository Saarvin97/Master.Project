...
<table class="table table-striped table-bordered">
   ...
   <tr>   
     ...
     <tr>   
        ...
        <th class="text-center"><div ><a href="ROC_EN_WE.php" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-eye-open"></span> View</a></div></th>	
    </tr>  
	  <tr>   
        <th class="text-center">Classification Report </th>
        <th class="text-center">Table </th>
        <th class="text-center"><div ><a href="CR_EN_WE.php" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-eye-open"></span> View</a></div></th>	
    </tr> 
	 <tr>   
        <th class="text-center">Learning Curve  </th>
        <th class="text-center">Line Chart </th>
        <th class="text-center"><div ><a href="LC_EN_WE.php" type="button" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-eye-open"></span> View</a></div></th>	
    </tr>
